import 'package:drivers_app/AllScreeens/newRideScreen.dart';
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 20.0,),
                    Expanded(child: Container(child: Text(rideDetails.pickup_addres,style: TextStyle( fontSize: 18.0),)),
                    ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 20.0,),
                    Expanded(
                      child:  Container(child: Text(rideDetails.dropoff_addres,style: TextStyle( fontSize: 18.0),)),),
